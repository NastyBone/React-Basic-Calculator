...
class Calculator extends React.Component {
  ...
  render() {
    ...
    React.createElement("input", { id: "display", value: this.state.onScreen.join(''), disabled: true }), /*#__PURE__*/
    React.createElement("input", { id: "inp", value: this.state.output, disabled: true })), /*#__PURE__*/


    React.createElement("div", { id: "buttons" },
    calcButtons.map(obj => {
      return /*#__PURE__*/React.createElement("button", { id: obj.id, onClick: this.caller.bind(this, obj.out), class: obj.class }, obj.out);
    })));
